<template>
	<div style="text-align: center;">
		<image :src="avatar" style="width: 200px; height: 200px; border-radius: 50%; margin: 20 auto;" mode="aspectFit"></image>	
	</div>
	<!-- 个人信息表格 -->
	<div style="width: 70%; margin: 0 auto;">
			<div style="background-color: #fff;">
				<view style="float: left;">用户名</view>
				<view style="float: right;">{{infoFormData.account}}</view>
			</div>
	</div>
</template>
